...
def store_data_dump(data_dump):
	"""
	save a given data dump to files.

	data_dump has to be formatted like the input of format_data
	"""

	#create these output formats
	output_formats  = ["csv", "struct", "cfile"]

	dontedit = """
//do not edit this file!
//make changes in the convert script and regenerate the structs files."""
