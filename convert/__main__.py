...
//make changes in the converter script and regenerate the structs files.
...
\n\n""",
	...
	for output_format in output_formats:
		...
		for output_name, output_data in formatted_data.items():
			...
			content_prefix = prefs["content_prefix"].format(filename=output_name.upper())
			content_suffix = prefs["content_suffix"].format(filename=output_name.upper())
