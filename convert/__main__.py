...
if __name__ == "__main__":
	...
	sp = p.add_subparsers(help="available convert subsystems")
	...
	media_cmd.add_argument("--nomerge", help="Don't merge frames of slps onto a texture atlas, create single files instead", action='store_true')
	...
	gcmd_g0 = genfile_cmd.add_mutually_exclusive_group()
	...
	genfile_cmd.set_defaults(handler=datafile.struct_generate)
