...
static constexpr auto GLSL_TYPE_NAME = datastructure::create_const_map<GLenum, const char*>(
	std::make_pair(GL_FLOAT, "float"),
	std::make_pair(GL_FLOAT_VEC2, "vec2"),
	std::make_pair(GL_FLOAT_VEC3, "vec3"),
	std::make_pair(GL_FLOAT_VEC4, "vec4"),
	std::make_pair(GL_INT, "int"),
	std::make_pair(GL_INT_VEC2, "ivec2"),
	std::make_pair(GL_INT_VEC3, "ivec3"),
	std::make_pair(GL_INT_VEC4, "ivec4"),
	std::make_pair(GL_UNSIGNED_INT, "uint"),
	std::make_pair(GL_UNSIGNED_INT_VEC2, "uvec2"),
	std::make_pair(GL_UNSIGNED_INT_VEC3, "uvec3"),
	std::make_pair(GL_UNSIGNED_INT_VEC4, "uvec4"),
	std::make_pair(GL_BOOL, "bool"),
	std::make_pair(GL_BOOL_VEC2, "bvec2"),
	std::make_pair(GL_BOOL_VEC3, "bvec3"),
	std::make_pair(GL_BOOL_VEC4, "bvec4"),
	std::make_pair(GL_FLOAT_MAT2, "mat2"),
	std::make_pair(GL_FLOAT_MAT3, "mat3"),
	std::make_pair(GL_FLOAT_MAT4, "mat4"),
	std::make_pair(GL_FLOAT_MAT2x3, "mat2x3"),
	std::make_pair(GL_FLOAT_MAT2x4, "mat2x4"),
	std::make_pair(GL_FLOAT_MAT3x2, "mat3x2"),
	std::make_pair(GL_FLOAT_MAT3x4, "mat3x4"),
	std::make_pair(GL_FLOAT_MAT4x2, "mat4x2"),
	std::make_pair(GL_FLOAT_MAT4x3, "mat4x3"),
	std::make_pair(GL_SAMPLER_1D, "sampler1D"),
	std::make_pair(GL_SAMPLER_2D, "sampler2D"),
	std::make_pair(GL_SAMPLER_3D, "sampler3D"),
	std::make_pair(GL_SAMPLER_CUBE, "samplerCube"),
	std::make_pair(GL_SAMPLER_1D_SHADOW, "sampler1DShadow"),
	std::make_pair(GL_SAMPLER_2D_SHADOW, "sampler2DShadow"),
	std::make_pair(GL_SAMPLER_1D_ARRAY, "sampler1DArray"),
	std::make_pair(GL_SAMPLER_2D_ARRAY, "sampler2DArray"),
	std::make_pair(GL_SAMPLER_1D_ARRAY_SHADOW, "sampler1DArrayShadow"),
	std::make_pair(GL_SAMPLER_2D_ARRAY_SHADOW, "sampler2DArrayShadow"),
	std::make_pair(GL_SAMPLER_2D_MULTISAMPLE, "sampler2DMS"),
	std::make_pair(GL_SAMPLER_2D_MULTISAMPLE_ARRAY, "sampler2DMSArray"),
	std::make_pair(GL_SAMPLER_CUBE_SHADOW, "samplerCubeShadow"),
	std::make_pair(GL_SAMPLER_BUFFER, "samplerBuffer"),
	std::make_pair(GL_SAMPLER_2D_RECT, "sampler2DRect"),
	std::make_pair(GL_SAMPLER_2D_RECT_SHADOW, "sampler2DRectShadow"),
	std::make_pair(GL_INT_SAMPLER_1D, "isampler1D"),
	std::make_pair(GL_INT_SAMPLER_2D, "isampler2D"),
	std::make_pair(GL_INT_SAMPLER_3D, "isampler3D"),
	std::make_pair(GL_INT_SAMPLER_CUBE, "isamplerCube"),
	std::make_pair(GL_INT_SAMPLER_1D_ARRAY, "isampler1DArray"),
	std::make_pair(GL_INT_SAMPLER_2D_ARRAY, "isampler2DArray"),
	std::make_pair(GL_INT_SAMPLER_2D_MULTISAMPLE, "isampler2DMS"),
	std::make_pair(GL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY, "isampler2DMSArray"),
	std::make_pair(GL_INT_SAMPLER_BUFFER, "isamplerBuffer"),
	std::make_pair(GL_INT_SAMPLER_2D_RECT, "isampler2DRect"),
	std::make_pair(GL_UNSIGNED_INT_SAMPLER_1D, "usampler1D"),
	std::make_pair(GL_UNSIGNED_INT_SAMPLER_2D, "usampler2D"),
	std::make_pair(GL_UNSIGNED_INT_SAMPLER_3D, "usampler3D"),
	std::make_pair(GL_UNSIGNED_INT_SAMPLER_CUBE, "usamplerCube"),
	std::make_pair(GL_UNSIGNED_INT_SAMPLER_1D_ARRAY, "usampler2DArray"),
	std::make_pair(GL_UNSIGNED_INT_SAMPLER_2D_ARRAY, "usampler2DArray"),
	std::make_pair(GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE, "usampler2DMS"),
	std::make_pair(GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY, "usampler2DMSArray"),
	std::make_pair(GL_UNSIGNED_INT_SAMPLER_BUFFER, "usamplerBuffer"),
	std::make_pair(GL_UNSIGNED_INT_SAMPLER_2D_RECT, "usampler2DRect")
);
