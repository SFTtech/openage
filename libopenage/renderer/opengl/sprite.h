...
public:
  ...
  Renderable_test create(util::Path path,bool pers_bool,char tex_path[],int subtex,bool use_metafile,std::shared_ptr<ShaderProgram> shader,std::shared_ptr<Renderer> renderer,Eigen::Vector3f center_coord);
  ...
  Eigen::Transform<float, 3, 32> make_transform(bool pers_bool,Eigen::Vector3f center_coord);
  std::shared_ptr<UniformInput> get_uniform(sprite_texture texture,bool pers_bool,std::shared_ptr<ShaderProgram> shader,float X,float Y);
  //only sends positions instead of the entire transformation matrix
  std::shared_ptr<UniformInput> get_uniform2(sprite_texture texture,bool pers_bool,std::shared_ptr<ShaderProgram> shader,float X,float Y);
  ...
  Renderable_test make_render_obj(sprite_texture texture,bool pers_bool,int subtex,std::shared_ptr<ShaderProgram> shader,float X,float Y);
