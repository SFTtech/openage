...
static qgl_context_capabilities find_capabilities() {
...
QGlContext::QGlContext(const std::shared_ptr<QWindow> &window) :
	window{window} {
...
QGlContext::QGlContext(QGlContext &&other) :
	gl_context(other.gl_context), capabilities(other.capabilities) {
	other.gl_context = nullptr;
}

QGlContext &QGlContext::operator=(QGlContext &&other) {
...
std::shared_ptr<QOpenGLContext> QGlContext::get_raw_context() const {
	return this->gl_context;
}

qgl_context_capabilities QGlContext::get_capabilities() const {
	return this->capabilities;
}

void QGlContext::check_error() {
...
void QGlContext::set_vsync(bool on) {
	if (on) {
...
const std::weak_ptr<GlShaderProgram> &QGlContext::get_current_program() const {
	return this->last_program;
}


void QGlContext::set_current_program(const std::shared_ptr<GlShaderProgram> &prog) {
