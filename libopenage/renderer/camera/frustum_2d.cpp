...
Frustum2d::Frustum2d(const util::Vector2s &viewport_size,
	...
	this->update(viewport_size, view_matrix, projection_matrix, zoom_factor);
}
...
void Frustum2d::update(const util::Vector2s &viewport_size,
	...
	this->inv_zoom_factor = 1.0f / zoom_factor;
...
bool Frustum2d::in_frustum(const Eigen::Vector3f &scene_pos,
	...
	Eigen::Vector4f screen_pos = this->transform_matrix * Eigen::Vector4f(scene_pos[0], scene_pos[1], scene_pos[2], 1.0f);
	float x_ndc = screen_pos[0];
	float y_ndc = screen_pos[1];
