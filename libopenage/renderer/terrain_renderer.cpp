...
static const Eigen::Matrix4f calc_tile_scale_transform() {
...
const Eigen::Matrix4f TerrainRenderer::TILE_SCALE_TRANSFORM{calc_tile_scale_transform()};
...
void TerrainRenderer::render(const Eigen::Matrix4f& view_project_transform) const {
	...
	// TODO retrieve a RenderPass from TerrainRenderer instead of using Renderer directly
