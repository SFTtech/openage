...
Terrain::Terrain(AssetManager &assetmanager,
	...
	this->terrain_id_map_color_hi_map    = std::make_unique<uint8_t[]>(this->terrain_id_count);
	this->terrain_id_map_color_med_map   = std::make_unique<uint8_t[]>(this->terrain_id_count);
	this->terrain_id_map_color_low_map   = std::make_unique<uint8_t[]>(this->terrain_id_count);
	...
	for (size_t i = 0; i < this->terrain_id_count; i++) {
		...
		this->terrain_id_map_color_hi_map[terrain_id] = line->map_color_hi;
		this->terrain_id_map_color_med_map[terrain_id] = line->map_color_med;
		this->terrain_id_map_color_low_map[terrain_id] = line->map_color_low;
...
uint8_t Terrain::map_color_hi(terrain_t terrain_id) {
	this->validate_terrain(terrain_id);
	return this->terrain_id_map_color_hi_map[terrain_id];
}

uint8_t Terrain::map_color_med(terrain_t terrain_id) {
	this->validate_terrain(terrain_id);
	return this->terrain_id_map_color_med_map[terrain_id];
}

uint8_t Terrain::map_color_low(terrain_t terrain_id) {
	this->validate_terrain(terrain_id);
	return this->terrain_id_map_color_low_map[terrain_id];
}
