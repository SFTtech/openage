...
public:
	...
	virtual _T get(const tube_time_t &t) const=0;
...
public:
	...
	virtual void set_insert(const tube_time_t &at, const _T &value);
...
template <typename _T>
void ValueContainer<_T>::set_drop(const tube_time_t &at, const _T &value) {
