...
if typing.TYPE_CHECKING:
    from engine.convert.entity_object.conversion.converter_object import ConverterObjectContainer
    from engine.convert.entity_object.conversion.converter_object import ConverterObject
