...
if typing.TYPE_CHECKING:
    ...
    from engine.convert.entity_object.conversion.aoc.genie_tech import GenieTechEffectBundleGroup
    from engine.convert.entity_object.conversion.aoc.genie_terrain import GenieTerrainGroup
