...
from engine.convert.entity_object.conversion.aoc.genie_tech import BuildingUnlock
...
if typing.TYPE_CHECKING:
    ...
    from engine.convert.value_object.read.value_members import ArrayMember
