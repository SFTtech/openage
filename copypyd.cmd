...
@robocopy %CD%\build\openage\convert\value_object\read\media\RelWithDebInfo %CD%\build\convert\value_object\read\media\ *.pyd
@robocopy %CD%\build\openage\convert\processor\export\RelWithDebInfo %CD%\build\convert\processor\export\ *.pyd
@robocopy %CD%\build\openage\convert\service\export\png\RelWithDebInfo %CD%\build\convert\service\export\png\ *.pyd
