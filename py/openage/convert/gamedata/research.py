...
class Research(Exportable):
    ...
    data_format = (
        ...
        (READ, "required_tech_count", "int16_t"),       # a subset of the above required techs may be sufficient
        (READ, "civilisation_id", "int16_t"),
        ...
        (READ, "languate_dll_description", "uint16_t"),
        ...
        (READ, "button_id", "int8_t"),
        (READ, "pointers", "int32_t[3]"),               # [0]: 100000+lang_dll_name [1]: 149000+lang_dll_description [2]: -1
