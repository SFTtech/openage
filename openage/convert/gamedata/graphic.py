...
class GraphicAttackSound(GenieStructure):
    ...
    data_format = [
        (READ, "sound_props", StorageType.CONTAINER_MEMBER, SubdataMember(
            ref_type=SoundProp,
            length=3,
        )),
    ]
...
class Graphic(GenieStructure):
    ...
    data_format.extend([
        ...
        (READ_EXPORT, "layer", StorageType.INT_MEMBER, EnumLookupMember(       # originally 40 layers, higher -> drawn on top
        ...
        (READ_EXPORT, "player_color", StorageType.INT_MEMBER, "int8_t"),        # force given player color
        ...
        (READ, "coordinates", StorageType.CONTAINER_MEMBER, "int16_t[4]"),
        ...
        (READ_EXPORT, "sequence_type", StorageType.INT_MEMBER, "int8_t"),
        (READ_EXPORT, "id", StorageType.ID_MEMBER, "int16_t"),
        (READ_EXPORT, "mirroring_mode", StorageType.INT_MEMBER, "int8_t"),
    ])
    ...
    data_format.extend([
        (READ_EXPORT, "graphic_deltas", StorageType.CONTAINER_MEMBER, SubdataMember(
            ref_type=GraphicDelta,
            length="delta_count",
        )),

        # if attack_sound_used:
        (READ, "graphic_attack_sounds", StorageType.CONTAINER_MEMBER, SubdataMember(
