...
class FrameData(Exportable):
    ...
    data_format = []
    data_format.append((READ_EXPORT, "frame_count", "int16_t"))
    data_format.append((READ_EXPORT, "angle_count", "int16_t"))
    data_format.append((READ_EXPORT, "shape_id", "int16_t"))  # frame index
...
class TerrainAnimation(Exportable):
    ...
    data_format.append((READ, "frame_changed",              "int8_t"))        # has the drawframe changed since terrain was drawn
    data_format.append((READ, "drawn",                      "int8_t"))
...
class Terrain(Exportable):
    ...
    data_format.append((READ_EXPORT, "map_color_cliff_lt",  "uint8_t"))
    data_format.append((READ_EXPORT, "map_color_cliff_rt",  "uint8_t"))
    data_format.append((READ_EXPORT, "passable_terrain",    "int8_t"))
    data_format.append((READ_EXPORT, "impassable_terrain",  "int8_t"))

    data_format.append((READ_EXPORT, None, IncludeMembers(cls=TerrainAnimation)))

    data_format.append((READ_EXPORT, "elevation_graphics", SubdataMember(
...
class TerrainBorder(Exportable):
    ...
    data_format.append((READ, "frames", SubdataMember(
            ref_type=FrameData,
            length=19 * 12,  # number of tile types * 12
    )))

    data_format.append((READ, "draw_tile", "int16_t"))         # always 0
    data_format.append((READ, "underlay_terrain", "int16_t"))
    data_format.append((READ, "border_style", "int16_t"))
...
class TileSize(Exportable):
    ...
    data_format = []
    data_format.append((READ_EXPORT, "width", "int16_t"))
    data_format.append((READ_EXPORT, "height", "int16_t"))
    data_format.append((READ_EXPORT, "delta_z", "int16_t"))
