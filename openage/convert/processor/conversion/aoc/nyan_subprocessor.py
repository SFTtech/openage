...
from .nyan.ambient import ambient_group_to_game_entity
from .nyan.building import building_line_to_game_entity
from .nyan.civ import civ_group_to_civ
from .nyan.projectile import projectiles_from_line
...
from .nyan.variant import variant_group_to_game_entity
...
class AoCNyanSubprocessor:
    ...
    ambient_group_to_game_entity = staticmethod(ambient_group_to_game_entity)
    building_line_to_game_entity = staticmethod(building_line_to_game_entity)
    civ_group_to_civ = staticmethod(civ_group_to_civ)
    projectiles_from_line = staticmethod(projectiles_from_line)
    ...
    variant_group_to_game_entity = staticmethod(variant_group_to_game_entity)
