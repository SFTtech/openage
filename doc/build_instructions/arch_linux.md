...
`sudo pacman -S --needed python python-pillow python-numpy python-pygments cython libepoxy libpng ttf-dejavu freetype2 fontconfig harfbuzz cmake sdl2 sdl2_image opusfile opus-tools python-pylint qt5-declarative qt5-quickcontrols`
