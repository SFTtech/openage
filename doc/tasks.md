...
* This interface provides the AI all the knowledge needed for proper operation
* Exposes `C++` engine code to `Python`

### Asset management frontend
* (Preferably) a GUI program to edit game assets
  * Unit creation cost
  * Tech tree editing
  * Graphics and sounds
  * Etc.
...
* Maybe partially autogenerated by the conversion script and engine data format definitions as this:
  * Avoids redundancy on data format updates
